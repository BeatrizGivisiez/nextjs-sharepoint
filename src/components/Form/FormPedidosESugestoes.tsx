...
const url = `${baseURL}/Form/AddRequestsOrSuggestions`;
...
export const FormPedidosESugestoes = () => {
  ...
  return (
    <>
      ...
      <FormAlert
        ...
        sucessMessage={
          "Consulte a sua caixa de e-mail e siga as instruções para confirmar o seu pedido/sugestão, para darmos seguimento ao mesmo. Obrigado!"
        }
      />
    </>
  );
