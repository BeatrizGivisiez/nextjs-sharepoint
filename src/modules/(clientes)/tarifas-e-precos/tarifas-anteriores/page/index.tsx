...
const TarifasAnterioresPage = () => {
  ...
  return (
    <Box>
      <Breadcrumbs
        category="Clientes"
        mainPage="Tarifas e Preços"
        URLmainPage="/clientes/tarifas-e-precos/"
        subPage="Tarifas Anteriores"
      />
...
export default TarifasAnterioresPage;
